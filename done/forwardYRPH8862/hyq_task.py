...
class HyQTask:
    ...
    def __calc_orientation_reward(pose, reward_info: Dict, self) -> float:
        ...
        allowable_yaw_deg = 0.2  #rotation on z axis help to left or right
        ...
        allowable_roll_deg = 0.5    #rotation on x axis #body balancing , need with haa joint to keep body left right balancing 
        ...
        # Pitch penalty
        allowable_pitch_deg = 0.5#2.5  #rotation on y axis #need leg force to help balancing
