...
env_fn = lambda : gym.make('HyQ-v62')
...
logger_kwargs = dict(output_dir='data/HYQ_task62_faster_speed', exp_name='HYQ_faster_speed')#0.6:1
...
if __name__ == '__main__':
    run_kwargs_base = {'env_fn': env_fn, 
                  ...
                  'num_test_episodes': 1,
                  'save_checkpoint_path': "data/HYQ_faster_speed"
                }
    run_kwargs_normal = {'env_fn': env_fn, 
                  ...
                  'random_exploration': exploration().get_threshold,
                  'num_test_episodes': 1,
                  'load_checkpoint_path': "data/HYQ_faster_speed"
                }
